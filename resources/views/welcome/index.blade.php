...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/bootstrap/css/font-awesome.min.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('assets/bootstrap/css/flaticon.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('assets/bootstrap/css/owl.carousel.min.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('assets/bootstrap/css/barfiller.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('assets/bootstrap/css/magnific-popup.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('assets/bootstrap/css/slicknav.min.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('assets/bootstrap/css/style.css') }}" type="text/css">
...
<body>
            ...
            <ul>
                ...
                <li><a href="#">Pages</a>
                    <ul class="dropdown">
                        ...
                        <li><a href="./class-timetable.blade.php">Classes timetable</a></li>
                        <li><a href="./bmi-calculator.blade.php">Bmi calculate</a></li>
                ...
                <div class="col-lg-6">
                    <nav class="nav-menu">
                        <ul>
                            ...
                            <li><a href="./about-us.blade.php">About Us</a></li>
                            <li><a href="./class-details.blade.php">Classes</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-6 offset-lg-6">
                            <div class="hi-text">
                                ...
                                <a href="/login" class="primary-btn">Sing up</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="class-item">
                    <div class="ci-pic">
                        <img src="{{ asset('assets/img/classes/class-1.jpg') }}" alt="Weightlifting">
                    </div>
                    <div class="ci-text">
                        <span>STRENGTH</span>
                        <h5>Weightlifting</h5>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="class-item">
                    <div class="ci-pic">
                        <img src="{{ asset('assets/img/classes/class-2.jpg') }}" alt="Indoor cycling">
                    </div>
                    <div class="ci-text">
                        <span>Cardio</span>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="class-item">
                    <div class="ci-pic">
                        <img src="{{ asset('assets/img/classes/class-3.jpg') }}" alt="Kettlebell power">
                    </div>
                    <div class="ci-text">
                        <span>STRENGTH</span>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="class-item">
                    <div class="ci-pic">
                        <img src="{{ asset('assets/img/classes/class-4.jpg') }}" alt="Indoor cycling">
                    </div>
                    <div class="ci-text">
                        <span>Cardio</span>
            ...
            <div class="col-lg-6">
                <div class="class-item">
                    <div class="ci-pic">
                        <img src="{{ asset('assets/img/classes/class-5.jpg') }}" alt="Boxing">
                    </div>
                    <div class="ci-text">
                        <span>Training</span>
                        <h4>Boxing</h4>
    ...
    <div class="gallery">
        ...
        <div class="gs-item grid-wide set-bg" data-setbg="{{ asset('assets/img/gallery/gallery-1.jpg') }}">
            <a href="{{ asset('assets/img/gallery/gallery-1.jpg') }}" class="thumb-icon image-popup">
        ...
        <div class="gs-item set-bg" data-setbg="{{ asset('assets/img/gallery/gallery-3.jpg') }}">
            <a href="{{ asset('assets/img/gallery/gallery-3.jpg') }}" class="thumb-icon image-popup">
                <i class="fa fa-picture-o"></i>
            </a>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="fs-about">
                        <div class="fa-logo">
                            <a href="#"><img src="{{ asset('img/logo.png') }}" alt="Logo">
                            </a>
                        </div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
